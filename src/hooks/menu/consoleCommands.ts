...
export const COMMAND_CATALOG: ConsoleCommandDef[] = [
  ...
  { command: "addItem:Comida/Pan", description: "Añade Pan 🍞 (+20% hambre, validado)", category: "Items", qty: { min: 1, max: 9 } },
  { command: "addItem:Bebida/OdreAgua", description: "Añade Odre con Agua 💧 (+20% sed, deja Odre vacío)", category: "Items", qty: { min: 1, max: 9 } },
  { command: "addItem:Bebida/OdreVacio", description: "Añade Odre vacío 🏺 (validado)", category: "Items", qty: { min: 1, max: 9 } },
