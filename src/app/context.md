...
| `api/player.api.ts` | 17 | `fetchPlayer`/`savePlayerPos` (auth) + endpoints autoridad `/player/me/inventory` (get/add/use/remove) y `/player/me/skills` (get/train) con JWT + `apiMessage` para errores. |
