...
| `phaser-npc-deselected` | `MainScene:281` (ESC) | `useAppController:133` |
...
## Para Repomix
Crear `GameEvents.ts` aquí antes de que el bus crezca. Migrar `useAppController` y `MainScene` a helpers tipados para evitar typos.
